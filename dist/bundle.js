...
var pusatSiteRadar = [-6.892477,107.579566]
var map = L.map('map',{
  minZoom: 2,
  maxZoom: 20
}).setView(pusatSiteRadar,8);
...
var markerRadar=L.marker(pusatSiteRadar,{icon : radarIcon}).addTo(map);
markerRadar.bindTooltip("Site Radar Bandung");


var circle = L.circle(pusatSiteRadar,{
    color : 'red',
    radius: 463000,
    fillColor :'#f03',
    fillOpacity : 0.09
